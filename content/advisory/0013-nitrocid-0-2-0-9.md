+++
date = '2026-05-19T17:51:36+03:00'
title = 'Nitrocid 0.2.0.9 - Security Update Advisory'
+++

This release of Nitrocid v0.2.0.9 includes security bug fixes that are done by Terminaux 8.3.0 and 8.4.0.2. We advise users to upgrade to this version of the project to ensure that attack vectors are reduced.
