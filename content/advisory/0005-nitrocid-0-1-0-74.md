+++
date = '2026-04-01T15:12:33+03:00'
title = 'Nitrocid 0.1.0.74 - Security Update Advisory'
+++

This release of Nitrocid v0.1.0.74 includes security bug fixes that are done by Terminaux 8.2.1. We advise users to upgrade to this version of the project to ensure that attack vectors are reduced.
