+++
date = '2026-04-01T15:12:28+03:00'
title = 'Nitrocid 0.2.0.7 - Security Update Advisory'
+++

This release of Nitrocid v0.2.0.7 includes security bug fixes that are done by Terminaux 8.2.1. We advise users to upgrade to this version of the project to ensure that attack vectors are reduced.
